"""
Research script to build and analyze a LUCJ circuit for an H6 hydrogen chain with 2A bond length.
Similar to research/09_lucj but tailored for AWS jobs data comparison.
"""
...
def print_summary(
    ...
    print("  - qsci_convergence.png (plot)")
    print("  - energy_vs_samples.png (energy vs mean sample number)")
    print("  - statevector_coefficients.png (top 20 coefficients bar chart)")
    print("  - statevector_coefficients_rev.png (bottom 20 coefficients bar chart)")
