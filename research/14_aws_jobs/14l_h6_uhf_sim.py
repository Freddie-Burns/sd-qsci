"""
H6 chain simulation to compare to hardware.
"""
...
def main():
    ...
    patterns = {
        "antiferromagnetic": [1, -1, 1, -1, 1, -1],
        "ferromagnetic": [1, 1, 1, -1, -1, -1],
    }
    ...
    for label, pattern in patterns.items():
        ...
        qc_results = analysis.run_quantum_chemistry_calculations(mol, rhf, bond_length=None, uhf=uhf)
    ...
    qc_results_mean = analysis.run_quantum_chemistry_calculations(
        mol, rhf, bond_length=None, statevector=combined_sv_mean, uhf=uhf_combined
    )
    ...
    qc_results_highest = analysis.run_quantum_chemistry_calculations(
        mol, rhf, bond_length=None, statevector=combined_sv_highest, uhf=uhf_combined
    )
    ...
    plot.multi_run_convergence_comparison(base_data_dir, multi_results, title_prefix="H6 Chain")
    plot.multi_run_energy_vs_samples(base_data_dir, multi_results, title_prefix="H6 Chain")
